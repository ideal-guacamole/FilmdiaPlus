...
function setFilm(filmVO, pic, url, name, summary) {
...
$(window).load(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            setFilm(filmlist[0], thisweek_film1_pic, thisweek_film1_url);
            setFilm(filmlist[1], thisweek_film2_pic, thisweek_film2_url);
            setFilm(filmlist[2], thisweek_film3_pic, thisweek_film3_url);
            setFilm(filmlist[3], thisweek_film4_pic, thisweek_film4_url);
            setFilm(filmlist[4], thisweek_film5_pic, thisweek_film5_url);
        }
    });
    ...
    $.ajax({
        ...
        success: function (data) {
            filmlist = data;
            setFilm(filmlist[0], latest_film1_pic, latest_film1_url);
            setFilm(filmlist[1], latest_film2_pic, latest_film2_url);
            setFilm(filmlist[2], latest_film3_pic, latest_film3_url);
            setFilm(filmlist[3], latest_film4_pic, latest_film4_url);
            setFilm(filmlist[4], latest_film5_pic, latest_film5_url);
        }
    });
    ...
    $.ajax({
        ...
        success: function (data) {
            filmlist = data;
            setFilm(filmlist[0], coming_film1_pic, coming_film1_url);
            setFilm(filmlist[1], coming_film2_pic, coming_film2_url);
            setFilm(filmlist[2], coming_film3_pic, coming_film3_url);
            setFilm(filmlist[3], coming_film4_pic, coming_film4_url);
            setFilm(filmlist[4], coming_film5_pic, coming_film5_url);
        }
    });
});
